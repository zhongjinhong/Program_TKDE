...
%     end       
    ...
    Soft_LCM_result = sprintf('%.4f+%.4f', acc_Soft_LCM,std_Soft_LCM);
...
%     Soft_LCM2_result = sprintf('%.4f+%.4f', acc_Soft_LCM2,std_Soft_LCM2);
    ...
    result1 = {MV_result,M3V_result,LFC_result,PC_result,Soft_LCM_result}
...
%     acc=[acc_LFC,acc_M3V,acc_MV,acc_PC,acc_Soft_LCM];
